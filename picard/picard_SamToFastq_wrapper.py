...
#    parser.add_option('-x', '--maxjheap', dest='maxjheap', default='108g') ## Since Picard processes are taking forever, this will be default.
#    parser.add_option('-y', '--minjheap', dest='minjheap', default='72g') ## Setting this initially saves time in heap resizing. 
