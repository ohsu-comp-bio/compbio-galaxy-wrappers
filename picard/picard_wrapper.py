...
class PicardBase():
    ...
    def fixPicardOutputs(self,transpose,maxloglines):
        ...
        # JHL Added to provide the associated txt file as a Galaxy output for only this tool.
        if self.opts.txtout and self.picname == 'CollectAlignmentSummaryMetrics':
            shutil.copy(self.metricsOut, self.opts.txtout)
...
def __main__():
    ...
    op.add_option('', '--txtout', default='picard_text_output.txt')
