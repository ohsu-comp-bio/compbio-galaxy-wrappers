...
class MetricPrep(SampleMetrics):
    ...
    def _req():
        ...
        return {'QIAseq_V3_RNA': ['qthirty', 'averageDepth', 'percentUmi', 'total_on_target_transcripts',
                ...
                'IlluminaExome_V2-5_PlusMito': ['aligned_reads_in_target_region_pct',
                                                'average_alignment_coverage_over_target_region',
                                                'average_mitochondrial_coverage_over_target_region',
                                                'cnv_coverage_mad', 'cnv_median_bin_count',
                                                'cnv_number_of_amplifications', 'cnv_number_of_deletions',
                                                'cnv_number_of_filtered_records_unmapped_pct',
                                                'cnv_number_of_passing_amplifications',
                                                'cnv_number_of_passing_amplifications_pct',
                                                'cnv_number_of_passing_deletions',
                                                'cnv_number_of_passing_deletions_pct',
                                                'dragen_gc_pct_r1', 'dragen_gc_pct_r2',
                                                'estimated_read_length',
                                                'mapped_reads_pct',
                                                'mismatched_bases_r1_pct', 'mismatched_bases_r2_pct',
                                                ...
                                                'variants_indels_het_pass_pct',
                                                'variants_snps_pass_pct',
                                                'variants_ti_to_tv_ratio_pass',
                                                'x_median_autosomal_median', 'x_median_coverage',
                                                'y_median_autosomal_median', 'y_median_coverage'
                                                ],
