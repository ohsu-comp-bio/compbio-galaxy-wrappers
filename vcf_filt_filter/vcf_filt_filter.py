...
def supply_args():
    ...
    parser.add_argument('--filt_rm', help='Remove any record with this FILTER label.')
...
def check_filt_rm(filt, filt_check):
    """
