...
```{r, drugprediction, echo=FALSE, warning=FALSE, fig.height = 5, fig.width = 7}
...
kable(setNames(dT[order(dT$diff), c("Sample", "Threshold", "Drug_Label")] ,
               c("Sample", "Proportions in Breast Cancer Cell Line", "Drug Label")),align="c") %>%
...
kable(drug_table) %>%
  kable_styling(bootstrap_options = "striped", font_size = 9, full_width = T)
```
